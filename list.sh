...
debootstrap_url=https://github.com/phoenixxie/dl/releases/download/debootstrap/debootstrap-bionic-firststage.tar.xz
debootstrap_file=debootstrap-bionic-firststage.tar.xz
